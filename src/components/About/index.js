  ...
  return (
    <div className="container about">
      ...
      <div className="text-zone">
        ...
        <p><small><h4 style={{padding:'10px',color:"#ffd700"}}>Skills</h4>Java | JavaScript | ReactJS | HTML | CSS | Pyhton.</small>
        </p>
        
        <p><small><h4 style={{padding:'10px',color:"#ffd700"}}>Interets / Hobbies</h4>I have a wide range of interests that include photography, traveling,
          music,and gaming. These
          passions bring joy and fulfillment to my life, allowing me to express
          creativity, explore new places, appreciate diverse melodies, and engage in
          immersive gaming experiences.</small>
        </p>
      </div>
